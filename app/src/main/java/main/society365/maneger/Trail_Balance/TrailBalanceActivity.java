package main.society365.maneger.Trail_Balance;
...
public class TrailBalanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     builder = new AlertDialog.Builder(this);
        ...
        adapter = new TrailBalanceActivityAdapter(getApplicationContext(),movieList);
                ...
                public void onClick(DialogInterface dialog, int which) {
                  ...
                  /*  if(strName=="Custom Date"){
                    ...
                    else */if(strName=="This Year")
                    {
                        ...
                        year1= String.valueOf(calendartp.get(Calendar.YEAR));
