...
import main.society365.maneger.MarshMallowPermission;
import main.society365.maneger.showpdftest_file;
...
public class PartyLedgerDetailPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("legdrname",sname+" "+ledgerid+showpdfstatus);
...
*/
        ...
        adapter = new PartyLedgerDetailPageAdapter(getApplicationContext(),movieList);
