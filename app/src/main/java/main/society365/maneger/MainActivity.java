...
import main.society365.login.Login;
import main.society365.R;
import main.society365.maneger.Create_billCharges.CreateBill;
import main.society365.maneger.Expandablelist.ExpandableListAdapter;
import main.society365.maneger.MainReportTap.ReportFragment;
import main.society365.maneger.MomReport.MomFragment;
import main.society365.maneger.Report.Memberreport;
import main.society365.maneger.Report.Reports;
import main.society365.maneger.auditreport.AuditFragment;
import main.society365.maneger.settings.SettingFragment;
import main.society365.staticurl.StaticUrl;
import main.society365.user.changepass.change_password;
...
{
    String ufname,ulname,societyid,usrid,uemail,mno,utype,uprof,fltno,bldid,fltstatus,sname,saddress,joindate,buildingname,flatname;
    TextView username;
    ImageView uprofile;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item)
    {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.navigation_me:
                ...
                firstFragment = new ReportFragment();
                break;
