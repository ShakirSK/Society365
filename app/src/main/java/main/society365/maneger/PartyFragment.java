...
import main.society365.maneger.partyledger.PartyAdapter;
import main.society365.maneger.partyledger.partymodel;
...
public class PartyFragment extends Fragment {
   ...
   static Calendar calendartp2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sharedPreferences = this.getActivity().getSharedPreferences("main.society365", Context.MODE_PRIVATE);
                 ...
                 if(strName=="All Groups")
                    {
                     ...
                     String jsonString = sharedPreferences
                             .getString("jsonStringforallgroup", "0");
                     Log.d("onclickjsonString", String.valueOf(jsonString));
