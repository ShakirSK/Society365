package main.society365.maneger.MainReportTap;
...
import main.society365.maneger.Daybook.DayBookActivity;
import main.society365.maneger.Outstanding_Receivable.ReceivableActivity;
import main.society365.maneger.PartyFragment;
...
*/
        ...
        dividerItemDecoration = new DividerItemDecoration(recyclerView.getContext(), linearLayoutManager.getOrientation());
         ...
         text1 = new ArrayList<>(Arrays.asList("Member Summary","Party Ledger","Sales Register","Daybook",
                 "Payment Report","Receipt Register",
                "Trial balance Ledger","Trial balance Accounts","Cash Book Balance","Outstanding Receivable"));
        ...
        sharedPreferences = getActivity().getSharedPreferences("main.society365", Context.MODE_PRIVATE);
